...
class PrepareBaseModel:
    ...
    def _prepare_full_model(model,classes,freeze_all,freeze_till,learning_rate):
        ...
        # functional approach, model output passed for flattening
        flatten_in=tf.keras.layers.Flatten()(model.output)   # model output passed for flattening
        prediction=tf.keras.layers.Dense(units=classes,
                                        activation="softmax")(flatten_in) # flattened passed to prediction
    ...
    @staticmethod     # if defined as staticmethod then no need for self
