...
"""
model = tf.keras.models.load_model("model.h5")   # assuming the model is in the current location
...
if uploaded_file is not None:
    ...
    argmax_index = np.argmax(result, axis=1) # [0, 0] indexes with the highest values
    if argmax_index[0] == 0:
